...
const translations = {
  en: {
    ...
    "impressum.companyInfo.address": "Angerstraße 27, 83646 Bad Tölz, Deutschland",
    "impressum.companyInfo.companyNumber": "Company Number: J40000005859-1",
    /* "impressum.companyInfo.taxId": "VAT: J40000005859-1", */
  ...
  de: {
    ...
    "impressum.companyInfo.name": "Service Tree",
    "impressum.companyInfo.address": "Angerstraße 27, 83646 Bad Tölz, Deutschland",
    "impressum.companyInfo.companyNumber": "Firmennummer: J40000005859-1",
    /* "impressum.companyInfo.taxId": "Steuernummer: J40000005859-1", */
  ...
  el: {
    ...
    "impressum.companyInfo.name": "Service Tree",
    "impressum.companyInfo.address": "Angerstraße 27, 83646 Bad Tölz, Deutschland",
    "impressum.companyInfo.companyNumber": "Αριθμός Εταιρείας: J40000005859-1",
    /* "impressum.companyInfo.taxId": "ΑΦΜ: J40000005859-1", */
